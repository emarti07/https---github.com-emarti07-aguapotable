...
$columns = ['id_contribuyente', 'nombre', 'apellido','tipo_de_persona','fecha_contrato'];
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td>' . $row['tipo_de_persona'] . '</td>';
        $output['data'] .= '<td>' . $row['fecha_contrato'] . '</td>';
        ...
        $output['data'] .= '<td><a class="btn btn-outline-info" href="#" data-toggle="modal" data-target="#verModal" data-id="' . $row['id_contribuyente'] . '">Ver</a></td>';
