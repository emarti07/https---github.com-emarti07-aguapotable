...
function Header()
{
    ...
    $this->Cell(27,10,'',1,0,'C',0);
    $this->Cell(27,10,'',1,0,'C',0);
    $this->Cell(20,10,'',1,0,'C',0);
    $this->Cell(20,10,'',1,0,'C',0);
    $this->Cell(22,10,'',1,1,'C',0);
...
while ($row=$resultado->fetch_assoc()) {
    ...
    $pdf->Cell(30,10,$row[''],1,0,'C',0);
	$pdf->Cell(27,10,'$'.$row[''],1,0,'C',0);
    $pdf->Cell(27,10,'$'.$row[''],1,0,'C',0);
    $pdf->Cell(20,10,'$'.$row[''],1,0,'C',0);
    $pdf->Cell(22,10,$row[''],1,1,'C',0);
